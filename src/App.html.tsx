...
import { Login, Register, Dashboard, WishlistDetail, Profile, VerifyEmail, Setup } from 'pages';
...
export const AppContentTemplate: React.FC<AppContentTemplateProps> = ({
  ...
  <div className="app-container">
    <Navigation />
    <VerificationBanner />
    <main className={`${isProfilePage ? 'profile-main-content' : 'main-content'} ${hasBanner ? 'has-verification-banner' : ''} animate-fade-in`}>
      <Routes>
