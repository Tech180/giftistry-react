...
export const SetupTemplate: React.FC<SetupTemplateProps> = ({
  ...
  const renderDatabaseStep = () => (
    <div className={styles.formSection}>
      <h3 className={styles.sectionTitle}>
        <Database size={16} style={{ color: '#5e6ad2' }} />
      ...
      {dbType === 'local' ? (
        <div className={`${styles.banner} ${styles.bannerInfo}`}>
          <Server size={16} style={{ flexShrink: 0, marginTop: 2, color: '#a5b4fc' }} />
          <div>
        ...
        <div className={styles.formGroup}>
          ...
          />
          {errors.dbUrl && <span style={{ color: '#fda4af', fontSize: 11, marginTop: 4, display: 'block' }}>{errors.dbUrl}</span>}
        </div>
      )}
    </div>
  );
  ...
  const renderSMTPStep = () => (
    <div className={styles.formSection}>
      <h3 className={styles.sectionTitle}>
        <Mail size={16} style={{ color: '#5e6ad2' }} />
      ...
      {smtpType === 'local' ? (
        ...
        <>
          ...
          {errors.smtp && <span style={{ color: '#fda4af', fontSize: 11, marginTop: 4, display: 'block' }}>{errors.smtp}</span>}
        </>
      )}
    </div>
  );
  ...
  const renderAdminStep = () => (
    <div className={styles.formSection}>
      <h3 className={styles.sectionTitle}>
        <User size={16} style={{ color: '#5e6ad2' }} />
      ...
      <div className={styles.formGroupInline}>
        <div>
          ...
          />
          {errors.adminFirstName && <span style={{ color: '#fda4af', fontSize: 11, marginTop: 4, display: 'block' }}>{errors.adminFirstName}</span>}
        </div>
        <div>
          ...
          />
          {errors.adminLastName && <span style={{ color: '#fda4af', fontSize: 11, marginTop: 4, display: 'block' }}>{errors.adminLastName}</span>}
        </div>
      </div>
      ...
      <div className={styles.formGroupInline}>
        <div>
          ...
          />
          {errors.adminUsername && <span style={{ color: '#fda4af', fontSize: 11, marginTop: 4, display: 'block' }}>{errors.adminUsername}</span>}
        </div>
        <div>
          ...
          />
          {errors.adminEmail && <span style={{ color: '#fda4af', fontSize: 11, marginTop: 4, display: 'block' }}>{errors.adminEmail}</span>}
        </div>
      </div>
      ...
      <div className={styles.formGroupInline}>
        <div>
          ...
          />
          {errors.adminPassword && <span style={{ color: '#fda4af', fontSize: 11, marginTop: 4, display: 'block' }}>{errors.adminPassword}</span>}
        </div>
        <div>
          ...
          />
          {errors.adminConfirmPassword && <span style={{ color: '#fda4af', fontSize: 11, marginTop: 4, display: 'block' }}>{errors.adminConfirmPassword}</span>}
        </div>
      </div>
    </div>
  );
