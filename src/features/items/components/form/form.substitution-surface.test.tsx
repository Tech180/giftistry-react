...
vi.mock('../audience-picker/audience-picker.component', () => ({
...
describe('FormTemplate substitution surface', () => {
  ...
  it('hides audience picker in read-only view mode', () => {
    render(<FormTemplate {...baseProps} readOnly substitutionEditor={null} />);
