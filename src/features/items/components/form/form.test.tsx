...
describe('Form - Dynamic Fields & Dependencies', () => {
  beforeEach(() => {
    vi.clearAllMocks();
...
describe('Form - Metadata hydration on edit', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(itemsApi.getFieldDefinitions).mockResolvedValue([]);
    vi.mocked(itemsApi.updateItem).mockResolvedValue(mockEditItem);
...
describe('Form - mutual AI button disable', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(itemsApi.getFieldDefinitions).mockResolvedValue([]);
  });
...
describe('Form - abandon pending job on close', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(itemsApi.getFieldDefinitions).mockResolvedValue([]);
...
describe('Form - suggestion visibility', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(itemsApi.getFieldDefinitions).mockResolvedValue([]);
  });
...
describe('Form readOnly view mode', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(itemsApi.getFieldDefinitions).mockResolvedValue([]);
  });
...
describe('Form - linked items multi-count restriction', () => {
  const peerItem: Item = {
    ...mockEditItem,
    Id: 'peer-1',
    Name: 'Peer Gift',
...
describe('Form - Substitution create surface', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(itemsApi.getFieldDefinitions).mockResolvedValue([]);
  });
  ...
  test('owner add-substitution starts with blank product fields', async () => {
    ...
    render(<Form {...baseFormProps} item={itemWithDetails} />);
...
describe('Form - Substitution drawer chrome entry path', () => {
...
describe('Form - Allow substitutions toggle', () => {
  const createdOption = {
    Id: 'sub-new',
  ...
  test('saving an owner substitution does not reset Allow toggle from API', async () => {
    ...
    render(<Form {...baseFormProps} item={itemWithAllowOff} />);
