...
export const CardTemplate: React.FC<TemplateProps> = ({
  ...
  return (
    <div
      className={`${styles.card} ${isSharesSidebarOpen ? styles['card--active'] : ''}`}
    >
      <Link
        to = {
            ...
            {!isOwner && wishlist.OwnerFirstName && (
              <div className={styles['owner-attribution']}>
                ...
                <UserPreviewCard
                  ...
                  displayName = {
                    wishlist.OwnerUsername || wishlist.OwnerFirstName
                  }
                  fallbackUser = {
                    {
                ...
                >
                  <UserAvatar
                    ...
                    initials = {
                      (wishlist.OwnerFirstName[0] || wishlist.OwnerUsername?.[0] || 'U').toUpperCase()
                    }
                    className = {
                      styles['owner-avatar']
                    }
                    imageClassName = {
                      styles['owner-avatar-img']
                    }
                    initialsClassName = {
                      styles['owner-avatar-initials']
                    }
                  />
                </UserPreviewCard>
              </div>
      ...
      {hasShares && (() => {
        ...
        return (
          <div
            className={`${styles['shares-sidebar']} ${isSharesSidebarOpen ? styles['shares-sidebar--open'] : ''}`}
                  ...
                  <div key={share.Id} className={styles['sidebar-item']}>
                    ...
                    >
                      <UserAvatar
                        ...
                        className = {
                          styles['sidebar-avatar']
                        }
                        imageClassName = {
                          styles['sidebar-avatar-img']
                        }
                        initialsClassName = {
                          styles['sidebar-avatar-initials']
                        }
                      />
                    </UserPreviewCard>
                  </div>
