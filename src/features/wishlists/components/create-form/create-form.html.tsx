...
import {
  CATEGORY_MENU_TITLE,
  CATEGORY_OPTIONS,
} from '../../constants/category-options.constant';
import { TemplateProps } from './interfaces/template-props.interface';
import styles from './create-form.module.css';


export const CreateFormTemplate: React.FC<TemplateProps> = ({
  title,
  setTitle,
  expiresAt,
  setExpiresAt,
    ...
    >
      ...
      <div className={styles['form-scroll-content']}>
        ...
        <Input
          ...
          placeholder = {
            'e.g., Birthday 2026, Office Secret Santa'
          }
          value = {
            title
          }
        ...
        <div className={styles['category-section']}>
          ...
          <div
            className={`${styles['grid-collapse']} ${category === 'custom' ? styles['grid-collapse--open'] : ''}`}
          >
            <div className={styles['grid-collapse__inner']}>
              <Input
                label = {
                ...
                onChange = {
                  (e) => setCustomCategory(e.target.value)
                }
                className = {
                  styles['input-group']
                }
        ...
        <div className={styles['advanced-section']}>
          ...
          <div
            ...
            className={`${styles['grid-collapse']} ${advancedOpen ? styles['grid-collapse--open'] : ''}`}
          ...
          {globalAiEnabled && (
            <div className={styles['ai-section-card']}>
              <div className={`${styles['toggle-wrapper']} ${styles['toggle-wrapper--flush']}`}>
                <div className={styles['toggle-text-block']}>
              ...
              {globalWebSearchEnabled && (
                <div className={`${styles['grid-collapse']} ${aiEnabled ? styles['grid-collapse--open'] : ''}`}>
                  <div className={styles['grid-collapse__inner']}>
                    <div className={styles['nested-toggle-container']}>
                      <div
                        className={`${styles['toggle-wrapper']} ${styles['nested-toggle']} ${!aiEnabled ? styles['toggle-wrapper--disabled'] : ''}`}
                      >
