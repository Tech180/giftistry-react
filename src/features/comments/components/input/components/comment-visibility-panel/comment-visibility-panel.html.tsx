...
import type { CommentVisibilityPanelTemplateProps } from './interfaces/comment-visibility-panel-template-props.interface';
import styles from './comment-visibility-panel.module.css';
...
export const CommentVisibilityPanelTemplate: React.FC<
  CommentVisibilityPanelTemplateProps
> = ({
  isMobile,
  isOwner,
  mode,
