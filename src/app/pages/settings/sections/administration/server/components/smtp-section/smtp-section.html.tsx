        ...
        <div className={styles['setting-row']}>
          ...
          <div className={styles['setting-action']}>
            <div className={segmentStyles['segmented-control']}>
              <button
                type="button"
                className={`${segmentStyles['segmented-control__btn']} ${smtpType === 'local' ? segmentStyles['segmented-control__btn--active'] : ''}`}
              ...
              <button
                type="button"
                className={`${segmentStyles['segmented-control__btn']} ${smtpType === 'remote' ? segmentStyles['segmented-control__btn--active'] : ''}`}
