      ...
      <div className={styles['setting-list']}>
        <div className={styles['setting-row']}>
          ...
          <div className={styles['setting-action']}>
            <div className={segmentStyles['segmented-control']}>
              <button
                type="button"
                className={`${segmentStyles['segmented-control__btn']} ${dbType === 'local' ? segmentStyles['segmented-control__btn--active'] : ''}`}
              ...
              <button
                type="button"
                className={`${segmentStyles['segmented-control__btn']} ${dbType === 'remote' ? segmentStyles['segmented-control__btn--active'] : ''}`}
        ...
        <div
          className={`${styles['expandable-area']} ${dbType === 'remote' ? styles['expandable-area--active'] : ''}`}
        >
