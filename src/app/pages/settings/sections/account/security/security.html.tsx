...
import { SecurityTemplateProps } from './interfaces/template-props.interface';
import { PasswordSection } from './components/password-section/password-section.component';
import { TwoFactorSection } from './components/two-factor-section/two-factor-section.component';
import styles from './security.module.css';

export const SecurityTemplate: React.FC<SecurityTemplateProps> = ({
  currentPassword,
  setCurrentPassword,
  newPassword,
  setNewPassword,
