...
import { ThemingTemplateProps } from './interfaces/template-props.interface';
import styles from './theming.module.css';

export const ThemingTemplate: React.FC<ThemingTemplateProps> = ({
  themeName,
  setThemeName,
  isNameDisabled,
  colors,
...
export default ThemingTemplate;
