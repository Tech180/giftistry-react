 ...
 * Route-level loading uses React.lazy in components/content/content.html.tsx — do not import this barrel
...
export { default as FriendsPage } from './friends/friends.component';
export { default as InviteAcceptPage } from './invite-accept/invite-accept.component';
