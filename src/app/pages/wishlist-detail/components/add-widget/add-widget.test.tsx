...
import { AddWidget } from './add-widget.component';
...
describe('AddWidget', () => {
  ...
  test('hides Auto when auto-add is disabled', () => {
    render(<AddWidget {...baseProps} canAutoAdd={false} />);
  ...
  test('cancel exits input mode', () => {
    const onExitInputMode = vi.fn();
    render(
      <AddWidget {...baseProps} isInputMode={true} onExitInputMode={onExitInputMode} />
    );
